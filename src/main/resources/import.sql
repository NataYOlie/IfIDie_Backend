...
INSERT INTO `task` (`id_task`,`default_task`, `description`, `external_link`, `header`,`previsional_date`, `subtype`, `task_color`, `validation_date`, `visible`, `list_type_id_task_type`, `user_id_user`) VALUES (1, true, 'C’est un point du testament mais qui peut être traité individuellement. ', 'https://www.demarches.interieur.gouv.fr/particuliers/peut-on-designer-personne-occuper-enfant-deces ', 'Garde des enfants', null, 'Famille', '#12a3df', null, true, 1, 1);
INSERT INTO `task` (`id_task`,`default_task`, `description`, `external_link`, `header`,`previsional_date`, `subtype`, `task_color`, `validation_date`, `visible`, `list_type_id_task_type`, `user_id_user`) VALUES (2, true, 'Trouver une personne qui pourra les prendre en charge.', '', 'Animaux domestiques', null, 'Famille', '#12a3df', null, true, 1, 1);
INSERT INTO `task` (`id_task`,`default_task`, `description`, `external_link`, `header`,`previsional_date`, `subtype`, `task_color`, `validation_date`, `visible`, `list_type_id_task_type`, `user_id_user`) VALUES (3, true, 'Identité :- carte d’identité, passeport, permis de conduire… - Directives anticipées - testament - Documents relatifs aux comptes bancaires, actifs, assurances vies actes de propriété carte grise carnets de santé / documents liés à la santé des enfants à charge ou des personnes dépendantes carnets de santé / documents liés à la santé des animaux de compagnies.', '', 'Documents à regrouper en un lieu centralisé, faire des copies etc : ', null, 'Administratif', '#fcd200', null, true, 1, 1);
